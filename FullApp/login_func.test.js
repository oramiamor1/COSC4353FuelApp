...
const {checkGallonReq,testLogin, validateUser, checkPwd,checkName, checkAddress1, checkAddress2, checkCity, checkZipcode,checkGalreq, checkDate, validateDate} = require("./client/js/login_func.js");
